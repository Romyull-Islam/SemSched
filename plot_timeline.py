"""
plot_timeline.py — generates a supplementary per-token CXL bus timeline figure.

Output:
    figures/fig_duplex_timeline.pdf

Input:
    duplex_timeline_data.csv  (generated by generate_timeline_data.py)

This is a supplementary illustrative figure (Baseline Simplex vs SemDuplex
bus utilization, zoomed on token 1, first 5 layers). It is NOT Fig 8 of the
paper — Fig 8 is produced by plot_paper_figures.py::plot_stall_duplex_phy().
"""
import pandas as pd
...
def plot_timeline_comparison():
    ...
    save_path = "figures/fig_duplex_timeline.pdf"
    plt.savefig(save_path, bbox_inches='tight')
    plt.close(fig)

    print(f"\n>>> Saved supplementary timeline figure: {save_path}")
